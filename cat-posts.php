...
class CategoryPosts extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        $valid_sort_orders = ['date', 'title', 'comment_count', 'random'];
    ...
    function update($new_instance, $old_instance)
    {
        ...
        if (function_exists('the_post_thumbnail')) {
            $sizes = get_option('jlao_cat_post_thumb_sizes');
            if (!$sizes) $sizes = [];
            $sizes[$this->id] = [$new_instance['thumb_w'], $new_instance['thumb_h']];
    ...
    function form($instance)
    {
        ...
        <p>
            <label>
                <?php _e('Category'); ?>:
                <?php wp_dropdown_categories(['name' => $this->get_field_name("cat"), 'selected' => $instance["cat"]]); ?>
            </label>
        </p>
        ...
        <p>
            <label for="<?php echo $this->get_field_id("num"); ?>">
                ...
                <input style="text-align: center;" id="<?php echo $this->get_field_id("num"); ?>"
                       name="<?php echo $this->get_field_name("num"); ?>" type="text"
                       value="<?php echo absint($instance["num"]); ?>" size='3'/>
            </label>
        </p>
        ...
        <p>
            <label for="<?php echo $this->get_field_id("title_link"); ?>">
                <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("title_link"); ?>"
                       name="<?php echo $this->get_field_name("title_link"); ?>"<?php checked((bool)$instance["title_link"], true); ?> />
        ...
        <p>
            ...
            <input style="text-align: center;" type="text" id="<?php echo $this->get_field_id("excerpt_length"); ?>"
                   ...
                   value="<?php echo $instance["excerpt_length"]; ?>" size="3"/>
        </p>
